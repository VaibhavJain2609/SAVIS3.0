export default class coverageChart{
    constructor(canvasEle, importData, orientation){
    ...
    updateChartData(rawDataArrays){
        //const chartData = this.buildCoverageIntervals(rawDataArrays)
